...
namespace iTalk
{
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (Bitmap bitmap = new Bitmap(this.Width, this.Height))
            {
                using (Graphics graphics = Graphics.FromImage(bitmap))
                {
                    ...
                    using (LinearGradientBrush brush2 = new LinearGradientBrush(this.ClientRectangle, Color.FromArgb(5, 86, 147), Color.FromArgb(5, 86, 147), LinearGradientMode.Vertical))
                    {
    ...
    class iTalk_TabControl : TabControl
    {
        ...
        public iTalk_TabControl()
        {
            ...
            {
                Page.BackColor = Color.FromArgb(37,46, 59);
            }
        }
        ...
        protected override void OnControlAdded(ControlEventArgs e)
        {
            ...
            if (e.Control is TabPage)
            {
                ...
                {
                    e.Control.BackColor = Color.FromArgb(37,46,59);
                }
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _Graphics.Clear(Color.FromArgb(37, 46, 59));
            ...
            _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(26, 32, 40)), new Rectangle(-5, 0, ItemSize.Height + 4, Height));
            ...
            for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++)
            {
                if (TabIndex == SelectedIndex)
                {
                    ...
                    // Draw background of the selected tab   5; 86; 147 37; 46; 59
                    _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(37,46,59)), TabRect.X, TabRect.Y, TabRect.Width - 4, TabRect.Height + 3);
                    ...
                    // Draw tab text
                    _Graphics.DrawString(TabPages[TabIndex].Text, new Font(Font.FontFamily, Font.Size, FontStyle.Bold), new SolidBrush(Color.FromArgb(5, 86, 147)), new Rectangle(TabRect.Left + 40, TabRect.Top + 12, TabRect.Width - 40, TabRect.Height), new StringFormat { Alignment = StringAlignment.Near });
                ...
                {
                    Rectangle TabRect = new Rectangle(new Point(GetTabRect(TabIndex).Location.X - 2, GetTabRect(TabIndex).Location.Y - 2), new Size(GetTabRect(TabIndex).Width + 3, GetTabRect(TabIndex).Height - 8));
                    _Graphics.DrawString(TabPages[TabIndex].Text, new Font(Font.FontFamily, Font.Size, FontStyle.Bold), new SolidBrush(Color.FromArgb(255, 255,255)), new Rectangle(TabRect.Left + 40, TabRect.Top + 12, TabRect.Width - 40, TabRect.Height), new StringFormat { Alignment = StringAlignment.Near });
